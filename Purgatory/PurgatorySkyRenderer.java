...
public class PurgatorySkyRenderer extends IRenderHandler
{
...
public void render(float partialTicks, WorldClient world, Minecraft mc) {
  ...
  mc.renderEngine.bindTexture("/mods/Purgatory/Enviroment/Purgatorysun.png"); // Sun texture + texture path
