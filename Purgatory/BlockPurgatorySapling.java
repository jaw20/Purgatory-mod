...
public class BlockPurgatorySapling extends BlockFlower
{
/** change the name to your sapling name **/
public static final String[] WOOD_TYPES = new String[] {"Purgatory"};
public BlockPurgatorySapling(int i, int j)
{
super(i);
float var3 = 0.4F;
...
if ((l & 8) == Main.PurgatoryGrass.blockID)
{
...
object = new WorldGenPurgatoryTree(true, 10 + par5Random.nextInt(20), 3, 3, false);
flag = true;
break;
}
}
...
i1 = 0;
/** Change this to your WorldGenNAMETree **/
object = new WorldGenPurgatoryTree(true, 4 + par5Random.nextInt(7), 3, 3, false);
}
}
else
{
/** Change this to your WorldGenNAMETree **/
object = new WorldGenPurgatoryTree(true); // Changed //
...
return par1 == Main.PurgatoryGrass.blockID || par1 == Block.dirt.blockID || par1 == Block.tilledField.blockID;
}
}