...
public class WorldProviderPurgatory extends WorldProvider
{
	...
	{
	this.worldChunkMgr = new WorldChunkManagerHell(Main.PurgatoryBiome, this.dimensionId, this.dimensionId);
	this.dimensionId = Main.DimID;
	this.hasNoSky = false;
	}
	public IChunkProvider createChunkGenerator()
	{
	return new ChunkProviderPurgatory(this.worldObj, this.worldObj.getSeed(), false);
	}
	...
	{
	if ((this instanceof WorldProviderPurgatory))
	{
	return "Entering Id Purgatory Dimension";
	}
	return null;
	}
	@SideOnly(Side.CLIENT)
	...
	{
	         return this.worldObj.getWorldVec3Pool().getVecFromPool(0.5, 0, 0);
	}

	public boolean isSkyColored1()
	{
	         return true;
	}
		@SideOnly(Side.CLIENT)
